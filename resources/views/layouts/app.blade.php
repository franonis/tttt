...
<html lang="zh-CN">
  <head>
      ...
      {{-- <script href="{{ asset('bootstrap-3.3.7-dist/js/bootstrap.min.js') }}"></script> --}}
      <script href="{{ asset('bootstrap-3.3.7-dist/js/bootstrap.min.js') }}"></script>

      <!-- Font Awesome 自动加载文件  -->
      {{-- <link href="{{ asset('bootstrap-3.3.7-dist/Font-Awesome-3.2.1/css/font-awesome.min.css') }}" rel="stylesheet"> --}}
      <link href="{{ asset('bootstrap-3.3.7-dist/Font-Awesome-3.2.1/css/font-awesome.min.css') }}" rel="stylesheet"crossorigin="anonymous">
