<footer>
      ...
      <div class="row"><h6 class="text-center">Copyright &copy; 2013-{{ date('Y') }} <a href="mailto:{{ env('APP_ADMIN') }}" data-toggle="tooltip" data-placement="top" title="Send e-mail to the web administrator">{{ env('APP_NAME') }}</a> All Rights Reserved.</h6></div>
      </footer>
