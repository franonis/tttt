...
<div class="container content">
    <div class="row">
        ...
        <div class="col-md-12">
                ...
                <form  id="pca" class="layui-form" action="/update/huatu">
                    <input name="path" value="{{ $path }}" style="display: none;">
                    <p>your jobs is running,click this butten to get the statistic result</p>
                    <button id="submitright" class="layui-btn" type="submit">Run</button>
                </form>
