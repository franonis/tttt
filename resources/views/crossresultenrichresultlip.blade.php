...
<div class="container content">
    <div class="row">
        ...
        <hr>
            ...
            <br><HR style="FILTER:alpha(opacity=100,finishopacity=0,style=3)" width="90%"color=#987cb9 SIZE=3></HR><br>
              <div class="col-md-12">
                    ...
                    <div class="col-md-10" style="border:1px dashed #000;">
                        <div class="col-md-5">
                            <a href="{{ url('download/file/')}}/{{ $downloadpath }}enrich++LION_enrichment.csv">LION_enrichment.csv<i class="layui-icon layui-icon-download-circle"></i></a>
                        </div>
                        <div class="col-md-5">
                            <a href="{{ url('download/file/')}}/{{ $downloadpath }}enrich++LION_enrichment-plot.png">LION_enrichment-plot.png<i class="layui-icon layui-icon-download-circle"></i></a>
                        </div>
                    </div>
        <br><HR style="FILTER:alpha(opacity=100,finishopacity=0,style=3)" width="90%"color=#987cb9 SIZE=3></HR>
                    ...
                    <div class="col-md-10">
                        <img src="http://www.lintwebomics.info/{{ $opath }}enrich/LION_enrichment-plot.png" style="height:50%;width: 60%;">
                    </div>
                </div>
            </div>
            <hr>
