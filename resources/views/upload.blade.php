...
<div class="container content">
    <div class="row">
        ...
        <label class="layui-form-label">Data file：</label>
        <div class="layui-input-block">
            <input type="radio" name="as" value="lipidomics" title="Cos7_integ_2.csv" checked="">
            <input type="radio" name="as" value="lipidomics" title="HANgene_tidy.CSV" checked="">
            <input type="radio" name="as" value="lipidomics" title="gene_tidy.CSV" checked="">
            <input type="radio" name="as" value="lipidomics" title="lipid_tidy2.CSV" checked="">
        </div>
        </div>
        <div class="layui-form-item">
        <label class="layui-form-label">Desc file：</label>
        <div class="layui-input-block">
            <input type="radio" name="af" value="lipidomics" title="Cos7_integ_sampleList.csv" checked="">
            <input type="radio" name="af" value="lipidomics" title="HANsampleList.CSV" checked="">
            <input type="radio" name="af" value="lipidomics" title="sampleList.CSV" checked="">
            <input type="radio" name="af" value="lipidomics" title="sampleList_lip.csv" checked="">
        </div>
