...
“Ranking mode” performs an enrichment analysis on a complete and ranked list of lipids.">Analysis data by <i class="layui-icon layui-icon-about"></i> : </label>
                                                <div class="layui-input-block" id="t">
                                                  <input type="radio" name="t" value="target_list" title="target_list" >
                                                  <input type="radio" name="t" value="ranking" title="ranking" checked="">
                                                </div>
                                            </div>
                                        </div>
                                        <div  class="col-md-12" id="target_list"  style="display: none;">
                                            <div class="col-md-3">
                                                <h4>Fold Change threshold: </h4>
                                            </div>
                                            <div class="col-md-9">
